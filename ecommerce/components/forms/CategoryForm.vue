  ...
  <section class="flex justify-center py-10">
    <div class="w-[500px]">
      ...
      <form @submit.prevent="submitCategory">
        ...
        <button
          type="submit"
          class="text-white bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center"
        >
          Submit
        </button>
      </form>
